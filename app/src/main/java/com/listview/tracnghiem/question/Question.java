...
public class Question {
    ...
    public Question(int id, String question, String ans_a, String ans_b, String ans_c, String ans_d, String result, int num_exam, String subject, String image,String traloi) {
        this.id = id;
